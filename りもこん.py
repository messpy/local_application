...
class ButtonApp:
    ...
    def setumei(self, number):
        ...
        if number == 1:
            ...
            return "Custom Information for Button 3"
        elif number == 4:
            return "Custom Information for Button 4"
        elif number == 5:
            return "Custom Information for Button 5"
        elif number == 6:
            return "Custom Information for Button 6"
        elif number == 7:
            return "Custom Information for Button 7"
        elif number == 8:
            return "Custom Information for Button 8"
        elif number == 9:
            return "Custom Information for Button 9"
        elif number == 10:
            return "Custom Information for Button 10"
        elif number == 11:
            return "Custom Information for Button" 
